...
try {
    ...
    $installActions = @(
        ...
        @{ name = 'komorebi-update.ps1'; source = (Join-Path $sourceScripts 'komorebi-update.ps1'); dest = (Join-Path $installDir 'komorebi-update.ps1'); type = 'program' },
        @{ name = 'komorebi-update.cmd'; source = (Join-Path $sourceScripts 'komorebi-update.cmd'); dest = (Join-Path $installDir 'komorebi-update.cmd'); type = 'program' },
